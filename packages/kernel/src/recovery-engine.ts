...
import { Journal } from "@pop-eye/journal";
...
export interface RecoveryEngineService {
  ...
  ) => Effect.Effect<RecoveryPlan, import("@pop-eye/journal").JournalError>;
  ...
  readonly dryRun: (
    ...
    import("@pop-eye/journal").JournalError
  >;
...
export class RecoveryEngine extends Context.Tag("@pop-eye/kernel/RecoveryEngine")<
  RecoveryEngine,
