...
Research baseline for the popeye plan. Produced 2026-08-10 from a
...
popeye is essentially that design finished, in Effect, dogfooded.
...
## popeye design direction (per ledger D-001..D-005)
