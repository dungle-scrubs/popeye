...
- **Run the live e2e:** `PEYE_LIVE_ENDPOINT=http://127.0.0.1:1234/v1 PEYE_LIVE_MODEL=lmstudio-community/qwen3.6-27b-mlx PEYE_LIVE_MODEL_ALT=openai/gpt-oss-20b pnpm vitest run --project @popeye/cli src/entry/live.test.ts` (10 tests; add `PEYE_LIVE_HOSTED_*` only for the hosted variant)
